...
public class BestCar {
	...
	public static void main(String[] args) {
		//once we create our own constructor compiler will not be creating default constructor
		//BestCar car=new BestCar();CE
		BestCar car=new BestCar("BMW","m5","Gray",2020, 4, 5);
		car.printDetails();
		
		//new BestCar("Toyota", "Camry", 2020, 2, 4, "Blue");CE wap arguments
	}
